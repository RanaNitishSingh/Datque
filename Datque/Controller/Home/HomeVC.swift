...
//            newBtnView.addSubview(btnView)
            let btnView1 = UIView()
                         ...
                         btnView1.frame = CGRect(x: (cardView.frame.size.width / 2) - 70 , y: 30, width: 55, height: 55)
                         ...
                         btnView3.frame = CGRect(x: (cardView.frame.size.width / 2) + 30 , y: 30, width: 55, height: 55)
                         let myFirstButton = UIButton()
