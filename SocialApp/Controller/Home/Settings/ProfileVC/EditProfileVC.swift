...
class EditProfileVC: UIViewController, GoToBackDelegate, GoToBackAppearanceDelegate, GoToBackDOBDelegate ,UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    var arrImgTblViewEdit = [  #imageLiteral(resourceName: "home 1") , #imageLiteral(resourceName: "persons.png"),  #imageLiteral(resourceName: "baby.png"), #imageLiteral(resourceName: "smoke.png"), #imageLiteral(resourceName: "drink.png"), #imageLiteral(resourceName: "relation.png"), #imageLiteral(resourceName: "persons.png"), #imageLiteral(resourceName: "male"), #imageLiteral(resourceName: "MAsk"), #imageLiteral(resourceName: "blood"), #imageLiteral(resourceName: "skin"), #imageLiteral(resourceName: "mdi_spoken-language.png"), #imageLiteral(resourceName: "mingcute_suitcase-2-fill.png"), #imageLiteral(resourceName: "religion 1"), #imageLiteral(resourceName: "study.png") ,  #imageLiteral(resourceName: "male")]
