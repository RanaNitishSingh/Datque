...
extension ChatVC {
    ...
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
        ...
        if path.contains("pdf") {
            //let data = urls[0]
            pdfUrl = urls[0]
            let bubbleData = ChatBubbleData(text: self.txtMessage.text! + " \(curDate)", image: UIImage.init(named: "pdfimg"), gif: nil, date: Date(), type: BubbleDataType(rawValue: 0)!)
            ...
            docUrl = urls[0]
            let bubbleData = ChatBubbleData(text: self.txtMessage.text! + " \(curDate)", image: UIImage.init(named: "docimg"), gif: nil, date: Date(), type: BubbleDataType(rawValue: 0)!)
            addChatBubble(data: bubbleData)
    ...
    func ShowSingleChatMessage(objData:UserChatDetailData) {
            ...
            if objData.senderID == Defaults[PDUserDefaults.UserID] {
                ...
                switch msg_Type {
                  ...
                  case "text":
                    print("msg_Type:- text")
                    let chatBubbleData2 = ChatBubbleData(text: objData.text! + "\n\(strDate)" + "\n\(chat_Status)", image:nil, gif: nil, date: NSDate() as Date, type: .Mine)
                  ...
                  case "image":
                    ...
                    let chatBubbleData2 = ChatBubbleData(text: "\(strDate)" + "\n\(chat_Status)", image: image, gif: nil, date: NSDate() as Date, type: .Mine)
                    self.addChatBubble(data: chatBubbleData2)
                  ...
                  case "gif":
                    ...
                    if imageSent != "0" && imageSent != "" {
                        ...
                        let chatBubbleData2 = ChatBubbleData(text: "\(strDate)" + "\n\(chat_Status)", image: nil, gif: "\(urlgif)", date: NSDate() as Date, type: .Mine)
                        self.addChatBubble(data: chatBubbleData2)
                ...
                switch msg_Type {
                  ...
                  case "text":
                    ...
                    let chatBubbleData2 = ChatBubbleData(text: objData.text! + "\n\(strDate)", image:nil, gif: nil, date: NSDate() as Date, type: .Opponent)
                    self.addChatBubble(data: chatBubbleData2)
                  ...
                  case "image":
                    ...
                    let chatBubbleData2 = ChatBubbleData(text: "\(strDate)", image: image, gif: nil, date: NSDate() as Date, type: .Opponent)
                    self.addChatBubble(data: chatBubbleData2)
                  ...
                  case "gif":
                    ...
                    if imageSent != "0" && imageSent != "" {
                        ...
                        let chatBubbleData2 = ChatBubbleData(text: "\(strDate)", image: nil, gif: "\(urlgif)", date: NSDate() as Date, type: .Opponent)
                        self.addChatBubble(data: chatBubbleData2)
