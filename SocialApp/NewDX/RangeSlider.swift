...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var maximumValue: Double = 65.0 {
        willSet(newValue) {
    ...
    @IBInspectable public var lowerValue: Double = 19.0 {
        didSet {
    ...
    @IBInspectable public var upperValue: Double = 50.0 {
        didSet {
    ...
    func updateLayerFrames() {
       ...
       // trackLayer.frame = bounds.insetBy(dx: 0.0, dy: bounds.height/3)
        trackLayer.frame = bounds.insetBy(dx: 0.0, dy: ((bounds.height) + 10) / 3)
