...
open class DropDown: UITextField {
    ...
    @IBInspectable public var itemsColor: UIColor = .black
    @IBInspectable public var itemsTintColor: UIColor = .black
    @IBInspectable public var selectedRowColor: UIColor = .systemPurple
